                ...
                <div class="border border">
                    ...
                    <form action="#" method="POST">
                        <fieldset class="p-4">
                            ...
                            <input type="password" placeholder="Senha*" name="senha1" class="border p-3 w-100 my-2">
                            <input type="password" placeholder="Confirme a senha*" name="senha" class="border p-3 w-100 my-2">
