        ...
        <div class="row">
            ...
            <!--<div class="col-lg-6 pt-5 pt-lg-0">-->
                <div class="about-content">
                    <h3 class="font-weight-bold">Quem somos nós</h3>
                    <p>Somos alunos PUC-MINAS, cursando o curso de Sistemas de Informação e através
                    desse trabalho temos o objetivo de ajudar trabalhadores autônomos a divulgarem seus serviços. Gostaríamos de poder ajudar
                  no mercado informal brasileiro, já que essa parte do mercado se mostra com grande dificuldade em divulgar seus serviços.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <form action="#">
            ...
            <fieldset class="border border-gary p-4 mb-5">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <h6 class="font-weight-bold pt-4 pb-1">Titulo do anúncio:</h6>
                            <input type="text" class="border w-100 p-2 bg-white text-capitalize" placeholder="Título do anúncio">
                            ...
                            <div class="price">
                                ...
                                <div class="row px-3">
                                    <div class="col-lg-4 mr-lg-4 rounded bg-white my-2 ">
                                        <input type="text" name="price" class="border-0 py-2 w-100 price" placeholder="Preço"
                                            id="price">
                                    </div>
                                    <div class="col-lg-4 mrx-4 rounded bg-white my-2 ">
                                        <input type="checkbox" value="Negotiable" id="Negotiable">
                                        <label for="Negotiable" class="py-2">Negociável</label>
                                    </div>
                                </div>
                            </div>
                            <div class="choose-file text-center my-4 py-4 rounded">
                                <label for="file-upload">
                                    <span class="d-block font-weight-bold text-dark">Faça upload de imagens</span>
            ...
            <fieldset class="border p-4 my-5 seller-information bg-gray">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <h6 class="font-weight-bold pt-4 pb-1">Número:</h6>
                    ...
                    <div class="col-lg-6">
                        ...
                        <h6 class="font-weight-bold pt-4 pb-1">Endereço:</h6>
                        <input type="text" placeholder="Seu endereço" class="border w-100 p-2">
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset class="border bg-white p-4 my-5 ad-feature bg-gray">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h3 class="pb-3">Promover anúncio
                            <span class="float-right"><a class="text-right font-weight-normal text-success" href="#">Ganhe mais reconhecimento pormovendo seus anúncios</a></span>
                        </h3>
                    ...
                    <div class="col-lg-6 my-3">
                        <span class="mb-3 d-block">Selecione o método de pagamento</span>
                        <ul>
                            <li>
                            ...
                            <li>
                                ...
                                <label for="Credit-Card" class="font-weight-bold text-dark py-1">CARTÃO DE CRÉDITO</label>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <button type="submit" class="btn btn-primary d-block mt-2">Postar Anúncio</button>
        </form>
    </div>
</section>
